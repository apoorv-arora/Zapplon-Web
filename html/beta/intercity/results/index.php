      ...
      <div class="col-sm-3 col-xs-3">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown" style="margin-right: 30px;">
            ...
            {     
              ?>   
              <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal" style="font-size:15px;margin-top: 20px;background-color:rgba(255,153,0,1);border-color:rgba(255,153,0,1);padding-left:20px;padding-right:20px;border-radius:0px;">LOGIN</button><!--#ffcf00-->
...
<div class="row text-center">
  <div class="col-md-12  main">
    <div class="formBox row text-center tab-content">
      <div  class="oneWay col-md-12 text-center tab-pane active" id="form1" style="padding:30px 0 30px 5%;">
