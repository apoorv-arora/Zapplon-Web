<?php
session_start(); 
$_SESSION['confignum']=2;
include ("../../conf.php");
?>
<html xmlns:fb = "http://www.facebook.com/2008/fbml">

<head>
  <title>Which city will you visit ?</title>
  <link 
   ...
   <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
    ...
    <div class = "hero-unit">
     <p style="color:#26478A ;font-size:36px ;font-family:Helvetica">
       Which place will you visit in next 5 years?
     </p>
...
<!-- HERE I GO -->
<div style="height:600px; width:160px; position:fixed; ">
<script type="text/javascript"><!--
document.write('<s'+'cript type="text/javascript" src="http://adsoid.com/show.php?z=27&pl=100259&j=1&code='+new Date().getTime()+'"></s'+'cript>'); 
// --></script>
</div>
<!-- THE END -->
<!-- HERE I GO -->
<div style="height:600px; width:160px; position:fixed; left:1170px; ">
<script type="text/javascript"><!--
document.write('<s'+'cript type="text/javascript" src="http://adsoid.com/show.php?z=26&pl=100258&j=1&code='+new Date().getTime()+'"></s'+'cript>'); 
// --></script>
</div>
<!-- THE END -->
   ...
   <?php
   $arr1=array('../images/london.jpg','../images/paris.jpg','../images/sydney.jpg','../images/tokyo.jpeg','../images/mumbai.jpg','../images/varanasi.jpg');
...
<footer>
  <div style="background-color:#363536;position:absolute; top:210%;left:11%">
    <div class="container">
...
<?php else: ?>     <!-- Before login --> 
 <div>
  <img src="../images/citynight.jpg" width="100%" height="20%">
  ...
  <div class="inner-container" STYLE="position:absolute; top:18%; left:35%; right:20% ;bottom:50%">
    <div class="box">
      <h1><font color="white">Which city will you visit in next 5 years ? Click to find out</font></h1>
      <?php
...
<div STYLE="position:absolute; top:80%; left:5%; right:30% ;bottom:25%">
  <div class="container">
    <div class="row- text-center">
      <div class="col-md-12 social segment">
        <h4 align="middle"><font color="#ffc206">Stay Connected</font></h4>
        <a href="https://www.facebook.com/Zapplon-412520788943370/?fref=ts" target="_blank"><i class="fa fa-facebook fa-3x"></i></a>
        <a href="https://www.linkedin.com/company/10168009?trk=prof-exp-company-name" target="_blank"><i class="fa fa-linkedin fa-3x"></i></a>
      </div><!-- /.col-md-12 -->
    </div><!-- /.row -->
    ...
    <div class="col- text-center"align="middle">
      <font color="#ffc206">
        <a href="cities.html" target="_blank"><font color="#ffc206">Cities</a></font>&nbsp; &nbsp;
        <a href="http://zapplon.wordpress.com" target="_blank"><font color="#ffc206">Blog</font></a>&nbsp; &nbsp;
        <div class="col- text-center"align="middle">
          <a href="privacy.html" target="_blank" ><font color="#ffc206">Privacy policy</font></a>
          <!-- /.col-md-12 -->
         ...
         <a href="terms.html" target="_blank"><font color="#ffc206">Terms &amp; conditions</font></a>
              ...
              document.getElementById('shareBtn').onclick = function() {
                ...
                FB.ui({
                  ...
                  href: 'http://zapplon.com/games/city/',
